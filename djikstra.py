...
class Graph(object):
    ...
    def dijkstra(graph, start_node):
        ...
        while unvisited_node:
            ...
            for neighbor in neighbors:
                distance = shortest_distance[current_min_node] + graph.value(current_min_node, neighbor)
    ...
    # Add the start node manually
        ...
        print("We found the following best path with a value of {}.".format(shortest_distance[target_node]))
